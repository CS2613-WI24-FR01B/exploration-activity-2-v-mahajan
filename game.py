...
class Window(QMainWindow):
    ...
    def UiComponents(self):
        ...
        self.user.setStyleSheet(
            "border: 2px solid black; background: #3498db; color: white;")
    ...
    def rock_action(self):
        ...
        self.user.setStyleSheet(
            "border-image: url(rock.png); background: #3498db; color: white;")
    ...
    def paper_action(self):
        ...
        # setting rock image to the user label
        self.user.setStyleSheet(
            "border-image: url(paper.png); background: #3498db; color: white;")
    ...
    def scissor_action(self):
        ...
        # setting rock image to the user label
        self.user.setStyleSheet(
            "border-image: url(scissor.png); background: #3498db; color: white;")
    ...
    def reset_action(self):
        ...
        self.user.setStyleSheet("border-image: none; background: #3498db; color: white;")
        self.computer.setStyleSheet("border-image: none; background: #3498db; color: white;")
